...
real(16) :: Omegam0, Omegar0, lambdachit, lambdasigmat, phitinitial, chitinitial, sigmatinitial
...
sigmatinitial = real(myparameter3,16)
! lambdaphit = real(10.0d0**myparameter4,16)
lambdachit = real(10.0d0**myparameter5,16)
lambdasigmat = real(10.0d0**myparameter6,16)
...
Hta2value = Hta2(real(a,16), Omegam0, Omegar0, lambdachit, lambdasigmat, phitinitial, chitinitial, sigmatinitial)

! Ha2 = Ha2LCDM1
! Ha2 = H0inMpcinsec*Hta2value
Ha2 = (Hta2value/Hta2LCDMvalue)*Ha2LCDM1

! write(*, *) a, (Hta2value/Hta2LCDMvalue)
...
function Hta2(ainput, Omegam0input, Omegar0input, lambdachitinput, &
& lambdasigmatinput, phitinitialinput, chitinitialinput, sigmatinitialinput)

implicit none

real(16) :: Hta2

real(16) :: ainput, Omegam0input, Omegar0input, lambdachitinput, &
& lambdasigmatinput, phitinitialinput, chitinitialinput, sigmatinitialinput

real(16) :: Omegam0, Omegar0, lambdachit, lambdasigmat, &
& phitinitial, chitinitial, sigmatinitial
common /inputparametersofHta2/ Omegam0, Omegar0, lambdachit, lambdasigmat, &
& phitinitial, chitinitial, sigmatinitial
...
! real(16), dimension(100000) :: arraya, arrayHt, arrayHtbuffer
! common /arrays/ arraya, arrayHt, arrayHtbuffer

! store background
real(16), dimension(100000) :: arraya, arrayHt, arrayHtbuffer, arrayphit, arrayphitp, &
& arraychit, arraychitp, arraysigmat, arraysigmatp
common /arrays/ arraya, arrayHt, arrayHtbuffer, arrayphit, arrayphitp, &
& arraychit, arraychitp, arraysigmat, arraysigmatp

integer :: imax
common /arrayindex/ imax

real(16) :: Omegam0flag, Omegar0flag, lambdachitflag, lambdasigmatflag, &
& phitinitialflag, chitinitialflag, sigmatinitialflag
common /flags/ Omegam0flag, Omegar0flag, lambdachitflag, lambdasigmatflag, &
& phitinitialflag, chitinitialflag, sigmatinitialflag

integer :: i

real(16) :: Neinitial, Htinitial, phitpinitial, chitpinitial, sigmatpinitial
real(16) :: aitoa0approx, Ne0approx
real(16) :: Ne0

real(16) :: phit0, phitp0, chit0, chitp0, sigmat0, sigmatp0

real(16) :: dNe

real(16) :: Nei, Hti, phiti, phitpi, chiti, chitpi, sigmati, sigmatpi
real(16) :: Neim1, Htim1, phitim1, phitpim1, chitim1, chitpim1, sigmatim1, sigmatpim1

real(16) :: dHt, dphit, dphitp, dchit, dchitp, dsigmat, dsigmatp

real(16) :: kHt01, kHt02, kHt03, kHt04, kHt05, kHt06, kHt07, kHt08, kHt09, kHt10
real(16) :: kphit01, kphit02, kphit03, kphit04, kphit05, kphit06, kphit07, kphit08, kphit09, kphit10
real(16) :: kphitp01, kphitp02, kphitp03, kphitp04, kphitp05, kphitp06, kphitp07, kphitp08, kphitp09, kphitp10
real(16) :: kchit01, kchit02, kchit03, kchit04, kchit05, kchit06, kchit07, kchit08, kchit09, kchit10
real(16) :: kchitp01, kchitp02, kchitp03, kchitp04, kchitp05, kchitp06, kchitp07, kchitp08, kchitp09, kchitp10
real(16) :: ksigmat01, ksigmat02, ksigmat03, ksigmat04, ksigmat05, ksigmat06, ksigmat07, ksigmat08, ksigmat09, ksigmat10
real(16) :: ksigmatp01, ksigmatp02, ksigmatp03, ksigmatp04, ksigmatp05, ksigmatp06, ksigmatp07, ksigmatp08, ksigmatp09, ksigmatp10

real(16) :: Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp

integer :: leftpoint, rightpoint, midpoint

real(16) :: d1cubicspline, d2cubicspline

real(16) :: Htcubicspline

Omegam0 = Omegam0input
Omegar0 = Omegar0input
lambdachit = lambdachitinput
lambdasigmat = lambdasigmatinput
phitinitial = phitinitialinput
chitinitial = chitinitialinput
sigmatinitial = sigmatinitialinput

if ((Omegam0 == Omegam0flag) .and. (Omegar0 == Omegar0flag) .and. &
& (lambdachit == lambdachitflag) .and. (lambdasigmat == lambdasigmatflag) .and. &
& (phitinitial == phitinitialflag) .and. (chitinitial == chitinitialflag) .and. &
(sigmatinitial == sigmatinitialflag)) then
goto 110
end if
...
lambdasigmatflag = lambdasigmat
phitinitialflag = phitinitial
chitinitialflag = chitinitial
sigmatinitialflag = sigmatinitial
...
& (chitinitial**4*lambdachit + lambdaphit*phitinitial**4 + &
& (4.0q0*rhomtinitial)/exp(3.0q0*Neinitial) + &
& (4.0q0*rhortinitial)/exp(4.0q0*Neinitial) + &
& lambdasigmat*sigmatinitial**4)

chitpinitial = (-4.0q0*chitinitial**3*lambdachit)/ &
& (chitinitial**4*lambdachit + lambdaphit*phitinitial**4 + &
& (4.0q0*rhomtinitial)/exp(3.0q0*Neinitial) + &
& (4.0q0*rhortinitial)/exp(4.0q0*Neinitial) + &
& lambdasigmat*sigmatinitial**4)

sigmatpinitial = (-4.0q0*lambdasigmat*sigmatinitial**3)/ &
& (chiti**4*lambdachit + lambdaphit*phitinitial**4 + &
& (4.0q0*rhomtinitial)/exp(3.0q0*Neinitial) + &
& (4.0q0*rhortinitial)/exp(4.0q0*Neinitial) + &
& lambdasigmat*sigmatinitial**4)
...
& (4.0q0*rhortinitial)/exp(4.0q0*Neinitial) + &
& lambdachit*chitinitial**4 + &
& lambdaphit*phitinitial**4 + &
& lambdasigmat*sigmatinitial**4)/ &
& (6.0q0 - chitpinitial**2 - &
& phitpinitial**2 - &
& sigmatpinitial**2))/sqrt(2.0q0)
...
chiti = chitinitial
chitpi = chitpinitial
sigmati = sigmatinitial
sigmatpi = sigmatpinitial
...
arraychit(i) = chiti
arraychitp(i) = chitpi
arraysigmat(i) = sigmati
arraysigmatp(i) = sigmatpi
...
kHt01 = dHt(Neim1, Htim1, phitim1, phitpim1, chitim1, chitpim1, sigmatim1, sigmatpim1)

kphit01 = dphit(Neim1, Htim1, phitim1, phitpim1, chitim1, chitpim1, sigmatim1, sigmatpim1)

kphitp01 = dphitp(Neim1, Htim1, phitim1, phitpim1, chitim1, chitpim1, sigmatim1, sigmatpim1)

kchit01 = dchit(Neim1, Htim1, phitim1, phitpim1, chitim1, chitpim1, sigmatim1, sigmatpim1)

kchitp01 = dchitp(Neim1, Htim1, phitim1, phitpim1, chitim1, chitpim1, sigmatim1, sigmatpim1)

ksigmat01 = dsigmat(Neim1, Htim1, phitim1, phitpim1, chitim1, chitpim1, sigmatim1, sigmatpim1)

ksigmatp01 = dsigmatp(Neim1, Htim1, phitim1, phitpim1, chitim1, chitpim1, sigmatim1, sigmatpim1)

Netemp = Neim1 + (4.0q0/27.0q0)*dNe

Httemp = Htim1 + (4.0q0/27.0q0)*dNe*kHt01

phittemp = phitim1 + (4.0q0/27.0q0)*dNe*kphit01

phitptemp = phitpim1 + (4.0q0/27.0q0)*dNe*kphitp01

chittemp = chitim1 + (4.0q0/27.0q0)*dNe*kchit01

chitptemp = chitpim1 + (4.0q0/27.0q0)*dNe*kchitp01

sigmattemp = sigmatim1 + (4.0q0/27.0q0)*dNe*ksigmat01

sigmatptemp = sigmatpim1 + (4.0q0/27.0q0)*dNe*ksigmatp01

kHt02 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit02 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp02 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit02 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp02 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat02 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp02 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Netemp = Neim1 + (2.0q0/9.0q0)*dNe

Httemp = Htim1 + (1.0q0/18.0q0)*dNe*(kHt01 + 3.0q0*kHt02)

phittemp = phitim1 + (1.0q0/18.0q0)*dNe*(kphit01 + 3.0q0*kphit02)

phitptemp = phitpim1 + (1.0q0/18.0q0)*dNe*(kphitp01 + 3.0q0*kphitp02)

chittemp = chitim1 + (1.0q0/18.0q0)*dNe*(kchit01 + 3.0q0*kchit02)

chitptemp = chitpim1 + (1.0q0/18.0q0)*dNe*(kchitp01 + 3.0q0*kchitp02)

sigmattemp = sigmatim1 + (1.0q0/18.0q0)*dNe*(ksigmat01 + 3.0q0*ksigmat02)

sigmatptemp = sigmatpim1 + (1.0q0/18.0q0)*dNe*(ksigmatp01 + 3.0q0*ksigmatp02)

kHt03 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit03 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp03 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit03 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp03 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat03 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp03 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Netemp = Neim1 + (1.0q0/3.0q0)*dNe

Httemp = Htim1 + (1.0q0/12.0q0)*dNe*(kHt01 + 3.0q0*kHt03)

phittemp = phitim1 + (1.0q0/12.0q0)*dNe*(kphit01 + 3.0q0*kphit03)

phitptemp = phitpim1 + (1.0q0/12.0q0)*dNe*(kphitp01 + 3.0q0*kphitp03)

chittemp = chitim1 + (1.0q0/12.0q0)*dNe*(kchit01 + 3.0q0*kchit03)

chitptemp = chitpim1 + (1.0q0/12.0q0)*dNe*(kchitp01 + 3.0q0*kchitp03)

sigmattemp = sigmatim1 + (1.0q0/12.0q0)*dNe*(ksigmat01 + 3.0q0*ksigmat03)

sigmatptemp = sigmatpim1 + (1.0q0/12.0q0)*dNe*(ksigmatp01 + 3.0q0*ksigmatp03)

kHt04 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit04 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp04 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit04 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp04 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat04 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp04 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Netemp = Neim1 + (1.0q0/2.0q0)*dNe

Httemp = Htim1 + (1.0q0/8.0q0)*dNe*(kHt01 + 3.0q0*kHt04)

phittemp = phitim1 + (1.0q0/8.0q0)*dNe*(kphit01 + 3.0q0*kphit04)

phitptemp = phitpim1 + (1.0q0/8.0q0)*dNe*(kphitp01 + 3.0q0*kphitp04)

chittemp = chitim1 + (1.0q0/8.0q0)*dNe*(kchit01 + 3.0q0*kchit04)

chitptemp = chitpim1 + (1.0q0/8.0q0)*dNe*(kchitp01 + 3.0q0*kchitp04)

sigmattemp = sigmatim1 + (1.0q0/8.0q0)*dNe*(ksigmat01 + 3.0q0*ksigmat04)

sigmatptemp = sigmatpim1 + (1.0q0/8.0q0)*dNe*(ksigmatp01 + 3.0q0*ksigmatp04)

kHt05 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit05 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp05 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit05 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp05 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat05 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp05 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Netemp = Neim1 + (2.0q0/3.0q0)*dNe

Httemp = Htim1 + (1.0q0/54.0q0)*dNe*(13.0q0*kHt01 - 27.0q0*kHt03 + 42.0q0*kHt04 + 8.0q0*kHt05)

phittemp = phitim1 + (1.0q0/54.0q0)*dNe*(13.0q0*kphit01 - 27.0q0*kphit03 + 42.0q0*kphit04 + 8.0q0*kphit05)

phitptemp = phitpim1 + (1.0q0/54.0q0)*dNe*(13.0q0*kphitp01 - 27.0q0*kphitp03 + 42.0q0*kphitp04 + 8.0q0*kphitp05)

chittemp = chitim1 + (1.0q0/54.0q0)*dNe*(13.0q0*kchit01 - 27.0q0*kchit03 + 42.0q0*kchit04 + 8.0q0*kchit05)

chitptemp = chitpim1 + (1.0q0/54.0q0)*dNe*(13.0q0*kchitp01 - 27.0q0*kchitp03 + 42.0q0*kchitp04 + 8.0q0*kchitp05)

sigmattemp = sigmatim1 + (1.0q0/54.0q0)*dNe*(13.0q0*ksigmat01 - 27.0q0*ksigmat03 + 42.0q0*ksigmat04 + 8.0q0*ksigmat05)

sigmatptemp = sigmatpim1 + (1.0q0/54.0q0)*dNe*(13.0q0*ksigmatp01 - 27.0q0*ksigmatp03 + 42.0q0*ksigmatp04 + 8.0q0*ksigmatp05)

kHt06 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit06 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp06 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit06 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp06 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat06 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp06 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Netemp = Neim1 + (1.0q0/6.0q0)*dNe

Httemp = Htim1 + (1.0q0/4320.0q0)*dNe*(389.0q0*kHt01 - 54.0q0*kHt03 + 966.0q0*kHt04 - 824.0q0*kHt05 + 243.0q0*kHt06)

phittemp = phitim1 + (1.0q0/4320.0q0)*dNe*(389.0q0*kphit01 - 54.0q0*kphit03 + 966.0q0*kphit04 - 824.0q0*kphit05 + 243.0q0*kphit06)

phitptemp = phitpim1 + (1.0q0/4320.0q0)*dNe*(389.0q0*kphitp01 - 54.0q0*kphitp03 + 966.0q0*kphitp04 - 824.0q0*kphitp05 + 243.0q0*kphitp06)

chittemp = chitim1 + (1.0q0/4320.0q0)*dNe*(389.0q0*kchit01 - 54.0q0*kchit03 + 966.0q0*kchit04 - 824.0q0*kchit05 + 243.0q0*kchit06)

chitptemp = chitpim1 + (1.0q0/4320.0q0)*dNe*(389.0q0*kchitp01 - 54.0q0*kchitp03 + 966.0q0*kchitp04 - 824.0q0*kchitp05 + 243.0q0*kchitp06)

sigmattemp = sigmatim1 + (1.0q0/4320.0q0)*dNe*(389.0q0*ksigmat01 - 54.0q0*ksigmat03 + 966.0q0*ksigmat04 - 824.0q0*ksigmat05 + 243.0q0*ksigmat06)

sigmatptemp = sigmatpim1 + (1.0q0/4320.0q0)*dNe*(389.0q0*ksigmatp01 - 54.0q0*ksigmatp03 + 966.0q0*ksigmatp04 - 824.0q0*ksigmatp05 + 243.0q0*ksigmatp06)

kHt07 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit07 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp07 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit07 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp07 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat07 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp07 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Netemp = Neim1 + dNe

Httemp = Htim1 + (1.0q0/20.0q0)*dNe*(-231.0q0*kHt01 + 81.0q0*kHt03 - 1164.0q0*kHt04 + 656.0q0*kHt05 - 122.0q0*kHt06 + 800.0q0*kHt07)

phittemp = phitim1 + (1.0q0/20.0q0)*dNe*(-231.0q0*kphit01 + 81.0q0*kphit03 - 1164.0q0*kphit04 + 656.0q0*kphit05 - 122.0q0*kphit06 + 800.0q0*kphit07)

phitptemp = phitpim1 + (1.0q0/20.0q0)*dNe*(-231.0q0*kphitp01 + 81.0q0*kphitp03 - 1164.0q0*kphitp04 + 656.0q0*kphitp05 - 122.0q0*kphitp06 + 800.0q0*kphitp07)

chittemp = chitim1 + (1.0q0/20.0q0)*dNe*(-231.0q0*kchit01 + 81.0q0*kchit03 - 1164.0q0*kchit04 + 656.0q0*kchit05 - 122.0q0*kchit06 + 800.0q0*kchit07)

chitptemp = chitpim1 + (1.0q0/20.0q0)*dNe*(-231.0q0*kchitp01 + 81.0q0*kchitp03 - 1164.0q0*kchitp04 + 656.0q0*kchitp05 - 122.0q0*kchitp06 + 800.0q0*kchitp07)

sigmattemp = sigmatim1 + (1.0q0/20.0q0)*dNe*(-231.0q0*ksigmat01 + 81.0q0*ksigmat03 - 1164.0q0*ksigmat04 + 656.0q0*ksigmat05 - 122.0q0*ksigmat06 + 800.0q0*ksigmat07)

sigmatptemp = sigmatpim1 + (1.0q0/20.0q0)*dNe*(-231.0q0*ksigmatp01 + 81.0q0*ksigmatp03 - 1164.0q0*ksigmatp04 + 656.0q0*ksigmatp05 - 122.0q0*ksigmatp06 + 800.0q0*ksigmatp07)

kHt08 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit08 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp08 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit08 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp08 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat08 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp08 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Netemp = Neim1 + (5.0q0/6.0q0)*dNe

Httemp = Htim1 + (1.0q0/288.0q0)*dNe*(-127.0q0*kHt01 + 18.0q0*kHt03 - 678.0q0*kHt04 + 456.0q0*kHt05 - 9.0q0*kHt06 + 576.0q0*kHt07 + 4.0q0*kHt08)

phittemp = phitim1 + (1.0q0/288.0q0)*dNe*(-127.0q0*kphit01 + 18.0q0*kphit03 - 678.0q0*kphit04 + 456.0q0*kphit05 - 9.0q0*kphit06 + 576.0q0*kphit07 + 4.0q0*kphit08)

phitptemp = phitpim1 + (1.0q0/288.0q0)*dNe*(-127.0q0*kphitp01 + 18.0q0*kphitp03 - 678.0q0*kphitp04 + 456.0q0*kphitp05 - 9.0q0*kphitp06 + 576.0q0*kphitp07 + 4.0q0*kphitp08)

chittemp = chitim1 + (1.0q0/288.0q0)*dNe*(-127.0q0*kchit01 + 18.0q0*kchit03 - 678.0q0*kchit04 + 456.0q0*kchit05 - 9.0q0*kchit06 + 576.0q0*kchit07 + 4.0q0*kchit08)

chitptemp = chitpim1 + (1.0q0/288.0q0)*dNe*(-127.0q0*kchitp01 + 18.0q0*kchitp03 - 678.0q0*kchitp04 + 456.0q0*kchitp05 - 9.0q0*kchitp06 + 576.0q0*kchitp07 + 4.0q0*kchitp08)

sigmattemp = sigmatim1 + (1.0q0/288.0q0)*dNe*(-127.0q0*ksigmat01 + 18.0q0*ksigmat03 - 678.0q0*ksigmat04 + 456.0q0*ksigmat05 - 9.0q0*ksigmat06 + 576.0q0*ksigmat07 + 4.0q0*ksigmat08)

sigmatptemp = sigmatpim1 + (1.0q0/288.0q0)*dNe*(-127.0q0*ksigmatp01 + 18.0q0*ksigmatp03 - 678.0q0*ksigmatp04 + 456.0q0*ksigmatp05 - 9.0q0*ksigmatp06 + 576.0q0*ksigmatp07 + 4.0q0*ksigmatp08)

kHt09 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit09 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp09 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit09 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp09 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat09 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp09 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Netemp = Neim1 + dNe

Httemp = Htim1 + (1.0q0/820.0q0)*dNe*(1481.0q0*kHt01 - 81.0q0*kHt03 + 7104.0q0*kHt04 - 3376.0q0*kHt05 + 72.0q0*kHt06 - 5040.0q0*kHt07 - 60.0q0*kHt08 + 720.0q0*kHt09)

phittemp = phitim1 + (1.0q0/820.0q0)*dNe*(1481.0q0*kphit01 - 81.0q0*kphit03 + 7104.0q0*kphit04 - 3376.0q0*kphit05 + 72.0q0*kphit06 - 5040.0q0*kphit07 - 60.0q0*kphit08 + 720.0q0*kphit09)

phitptemp = phitpim1 + (1.0q0/820.0q0)*dNe*(1481.0q0*kphitp01 - 81.0q0*kphitp03 + 7104.0q0*kphitp04 - 3376.0q0*kphitp05 + 72.0q0*kphitp06 - 5040.0q0*kphitp07 - 60.0q0*kphitp08 + 720.0q0*kphitp09)

chittemp = chitim1 + (1.0q0/820.0q0)*dNe*(1481.0q0*kchit01 - 81.0q0*kchit03 + 7104.0q0*kchit04 - 3376.0q0*kchit05 + 72.0q0*kchit06 - 5040.0q0*kchit07 - 60.0q0*kchit08 + 720.0q0*kchit09)

chitptemp = chitpim1 + (1.0q0/820.0q0)*dNe*(1481.0q0*kchitp01 - 81.0q0*kchitp03 + 7104.0q0*kchitp04 - 3376.0q0*kchitp05 + 72.0q0*kchitp06 - 5040.0q0*kchitp07 - 60.0q0*kchitp08 + 720.0q0*kchitp09)

sigmattemp = sigmatim1 + (1.0q0/820.0q0)*dNe*(1481.0q0*ksigmat01 - 81.0q0*ksigmat03 + 7104.0q0*ksigmat04 - 3376.0q0*ksigmat05 + 72.0q0*ksigmat06 - 5040.0q0*ksigmat07 - 60.0q0*ksigmat08 + 720.0q0*ksigmat09)

sigmatptemp = sigmatpim1 + (1.0q0/820.0q0)*dNe*(1481.0q0*ksigmatp01 - 81.0q0*ksigmatp03 + 7104.0q0*ksigmatp04 - 3376.0q0*ksigmatp05 + 72.0q0*ksigmatp06 - 5040.0q0*ksigmatp07 - 60.0q0*ksigmatp08 + 720.0q0*ksigmatp09)

kHt10 = dHt(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphit10 = dphit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kphitp10 = dphitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchit10 = dchit(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

kchitp10 = dchitp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmat10 = dsigmat(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

ksigmatp10 = dsigmatp(Netemp, Httemp, phittemp, phitptemp, chittemp, chitptemp, sigmattemp, sigmatptemp)

Nei = Neim1 + dNe

Hti = Htim1 + (1.0q0/840.0q0)*dNe*(41.0q0*kHt01 + 27.0q0*kHt04 + 272.0q0*kHt05 + 27.0q0*kHt06 + 216.0q0*kHt07 + 216.0q0*kHt09 + 41.0q0*kHt10)

phiti = phitim1 + (1.0q0/840.0q0)*dNe*(41.0q0*kphit01 + 27.0q0*kphit04 + 272.0q0*kphit05 + 27.0q0*kphit06 + 216.0q0*kphit07 + 216.0q0*kphit09 + 41.0q0*kphit10)

phitpi = phitpim1 + (1.0q0/840.0q0)*dNe*(41.0q0*kphitp01 + 27.0q0*kphitp04 + 272.0q0*kphitp05 + 27.0q0*kphitp06 + 216.0q0*kphitp07 + 216.0q0*kphitp09 + 41.0q0*kphitp10)

chiti = chitim1 + (1.0q0/840.0q0)*dNe*(41.0q0*kchit01 + 27.0q0*kchit04 + 272.0q0*kchit05 + 27.0q0*kchit06 + 216.0q0*kchit07 + 216.0q0*kchit09 + 41.0q0*kchit10)

chitpi = chitpim1 + (1.0q0/840.0q0)*dNe*(41.0q0*kchitp01 + 27.0q0*kchitp04 + 272.0q0*kchitp05 + 27.0q0*kchitp06 + 216.0q0*kchitp07 + 216.0q0*kchitp09 + 41.0q0*kchitp10)

sigmati = sigmatim1 + (1.0q0/840.0q0)*dNe*(41.0q0*ksigmat01 + 27.0q0*ksigmat04 + 272.0q0*ksigmat05 + 27.0q0*ksigmat06 + 216.0q0*ksigmat07 + 216.0q0*ksigmat09 + 41.0q0*ksigmat10)

sigmatpi = sigmatpim1 + (1.0q0/840.0q0)*dNe*(41.0q0*ksigmatp01 + 27.0q0*ksigmatp04 + 272.0q0*ksigmatp05 + 27.0q0*ksigmatp06 + 216.0q0*ksigmatp07 + 216.0q0*ksigmatp09 + 41.0q0*ksigmatp10)
...
! write(*,*) "chiti = ", chiti
! write(*,*) "chitpi = ", chitpi
! write(*,*) "sigmati = ", sigmati
! write(*,*) "sigmatpi = ", sigmatpi
...
lambdaphit = (12.0q0 - 2.0q0*phitp0**2 - lambdachit*chit0**4 - 2.0q0*chitp0**2 - lambdasigmat*sigmat0**4 - 2.0q0*sigmatp0**2 - 12.0q0*Omegam0 - 12.0q0*Omegar0)/phit0**4
...
end do ! while (abs((lambdaphit - lambdaphitold)/lambdaphit) >= 1.0q-3)

! write(*, *) "Ne0 = ", Ne0
! write(*, *) "Ne0approx", Ne0approx
! write(*, *) "Ne0 - Ne0approx = ", Ne0 - Ne0approx
...
do i = 1, imax
    ...
    ! store background
    write(11,"(8e25.16)") exp(arraya(i)), arrayHt(i), arrayphit(i), arrayphitp(i), &
    & arraychit(i), arraychitp(i), arraysigmat(i), arraysigmatp(i)
...
! d1cubicspline = (arrayHt(2)-arrayHt(1))/(arraya(2)-arraya(1))
! d2cubicspline = (arrayHt(imax)-arrayHt(imax-1))/(arraya(imax)-arraya(imax-1))
! call spline2(arraya(1:imax),arrayHt(1:imax),imax,d1cubicspline,d2cubicspline,arrayHtbuffer(1:imax))

110 if (ainput <= arraya(1)) then

! Radiation dominated
Hta2 = arrayHt(1)*arraya(1)**2

else if ((ainput > arraya(1)) .and. (ainput <= arraya(imax))) then
...
! {
! call spline_out2(arraya(1:imax),arrayHt(1:imax),arrayHtbuffer(1:imax),imax,ainput,Htcubicspline)
!
! Hta2 = Htcubicspline*ainput**2
! }

else if (ainput > arraya(imax)) then

Hta2 =  ainput**2*(arrayHt(imax) + &
& ((ainput - arraya(imax))* &
& (-arrayHt(imax - 1) + arrayHt(imax)))/ &
& (-arraya(imax - 1) + arraya(imax)))
...
function dHt(Ne, Ht, phit, phitp, chit, chitp, sigmat, sigmatp)

    implicit none

    real(16) :: dHt
    real(16) :: Ne, Ht, phit, phitp, chit, chitp, sigmat, sigmatp
    ...
    dHt = -(3.0q0*exp(Ne)*rhomtinitial + 4.0q0*rhortinitial)/(6.0q0*exp(4.0q0*Ne)*Ht) - (Ht*(chitp**2 + phitp**2 + sigmatp**2))/2.0q0

end function dHt

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

function dphit(Ne, Ht, phit, phitp, chit, chitp, sigmat, sigmatp)
...
function dphitp(Ne, Ht, phit, phitp, chit, chitp, sigmat, sigmatp)
    ...
    dphitp = (-6.0q0*lambdaphit*phit**3 + (phitp*(3.0q0*exp(Ne)*rhomtinitial + &
    & 4.0q0*rhortinitial + 3.0q0*exp(4.0q0*Ne)*Ht**2*(-6.0q0 + chitp**2 + &
    & phitp**2 + sigmatp**2)))/exp(4.0q0*Ne))/(6.0q0*Ht**2)

end function dphitp

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

function dchit(Ne, Ht, phit, phitp, chit, chitp, sigmat, sigmatp)
...
function dchitp(Ne, Ht, phit, phitp, chit, chitp, sigmat, sigmatp)
    ...
    dchitp = (-6.0q0*lambdachit*chit**3 + (chitp*(3.0q0*exp(Ne)*rhomtinitial + &
    & 4.0q0*rhortinitial + 3.0q0*exp(4.0q0*Ne)*Ht**2*(-6.0q0 + chitp**2 + &
    & phitp**2 + sigmatp**2)))/exp(4.0q0*Ne))/(6.0q0*Ht**2)
...
function dsigmat(Ne, Ht, phit, phitp, chit, chitp, sigmat, sigmatp)
...
end function dsigmat

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

function dsigmatp(Ne, Ht, phit, phitp, chit, chitp, sigmat, sigmatp)
    ...
    dsigmatp = (-6.0q0*lambdasigmat*sigmat**3 + &
    & (sigmatp*(3.0q0*exp(Ne)*rhomtinitial + 4.0q0*rhortinitial + &
    & 3.0q0*exp(4.0q0*Ne)*Ht**2*(-6.0q0 + chitp**2 + phitp**2 + &
    & sigmatp**2)))/exp(4.0q0*Ne))/(6.0q0*Ht**2)

end function dsigmatp
...
subroutine spline_out2(xarr,yarr,yarr_buff,n,x,y)
